...
snapshot.size;
        ...
        <tr>
            ...
            <td data-label="Roll No.">${docSnap.id}</td>
...
<td data-label="Teacher ID">${docSnap.id}</td>
...
<td data-label="Actions">
<div class="action-btns">
<button class="btn-view" onclick="viewTeacher('${docSnap.id}')"><i class="fa-solid fa-eye"></i> View</button>

<button class="btn-edit" onclick="editTeacher('${docSnap.id}')"><i class="fa-solid fa-pen-to-square"></i> Edit</button>

<button class="btn-delete" onclick="deleteTeacher('${docSnap.id}')"><i class="fa-solid fa-trash"></i> Delete</button>
</div>
</td>
